...
import tracyc from "../../../../public/assets/media/case-details/trac91/trac91.svg";
...
import keytrac1 from "../../../../public/assets/media/case-details/trac91/trac91livestatus.svg";
...
import case_d_css from "../../../../public/assets/media/case-details/allicon/css.svg";
            ...
            <div className="row work-area-lower-sides">
              ...
              <div className="work-lower-left col-12 col-sm-12 col-md-12 col-lg-6" data-aos="fade-right" data-aos-delay="300">
                <div className="work-area-logo">
                  <img className="work-logo" src={trac} alt="" />
                </div>
                ...
                <p className="work-area-lower-paragraph">
                  ...
                  effortless. <br />Instead of juggling multiple tracking apps or
                  searching through your email,<br /> just enter your phone number,
                  and Trac91 does the rest. It automatically <br /> pulls up real-time
                  updates for all your orders, so you can easily keep tabs <br />on
                  your deliveries from one convenient place. With Trac91, you’ll
                  always <br />know exactly where your purchases are, without the
                ...
                <div className="row row-cols-2 row-cols-lg-2 g-2 g-lg-3 mt-36">
                  ...
                  <div class="col">
                    <div class="case-d-result text-white p-3">
                      ...
                      <hr />
                      <p>Improvement in User <br/> Retention Rate.</p>
                    </div>
                  </div>
                  <div class="col">
                    <div class="case-d-result text-white p-3">
      ...
      <section className="key-object common_margin_space" data-aos="fade-up" data-aos-delay="300">
        <div className="container">
          <div className="row">
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-6" data-aos="fade-left" data-aos-delay="300">
              <img className="case_d_right_img" src={tracyc} alt="" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="Empowering-sec common_margin_space" data-aos="fade-up" data-aos-delay="300">
        <div className="container">
          <div className="row">
            <div className="commom-heading">
              <h2>
                Trac91 is a a one-step solution for all <br />online shopping order
                tracking{" "}
              </h2>
              <p>
          ...
          <div className="row emproving_secound">
            ...
            <div className="col-12 col-lg-4 col-md-12 col-sm-12 d-flex justify-content-center mt-md-5 mb-md-5 mb-sm-5 text-center">
              <div className="img_set">
                <img src={traccen} alt="" className=" w-100 h-100" />
              </div>
            </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-6 keybg" data-aos="fade-right" data-aos-delay="300">
              <img src={keytrac1} alt="" className="case_d_img" />
            </div>
          ...
          <div className="row key_sec_row">
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-6" data-aos="fade-left" data-aos-delay="300">
              <img src={keytrac2} alt="" className="case_d_right_img" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="row">
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-6" data-aos="fade-left" data-aos-delay="300">
              <div className="row row-cols-2 row-cols-lg-2 g-5 g-lg-5">
                ...
                <div className="col">
                  <div className="img-shadow">
                    <img src={case_d_css} alt="" className="w-100" />
                  </div>
                </div>
                <div className="col">
                  <div className="img-shadow">
