...
import case_d from "../../../../public/assets/media/case-details/endura/key2.svg";
import case_ds from "../../../../public/assets/media/case-details/endura/keyobject.svg";
        ...
        <>
                        ...
                        <div className="row work-area-lower-sides">
                            ...
                            <div className="work-lower-left col-12 col-sm-12 col-md-12 col-lg-6">
                                ...
                                <p className="work-area-lower-paragraph">
                                    Endura Fitness is your ultimate companion for a healthier lifestyle, combining personalized workout plans, expert nutrition guidance, and engaging features like pre-recorded sessions and quick workouts. With fresh content from top trainers and nutritionists, alongside unique offerings like "Creators Corner" and "Healthy Eats," Endura empowers you to achieve your fitness goals with ease and excitement.
                                </p>
            ...
            <section className="Empowering-sec common_margin_space">
                <div className="container">
                    <div className="row">
                        <div className="commom-heading">
                            <h2>Endura Fitness The Ultimate Solution for Fitness Enthusiasts and Trainers</h2>
                            <p>
