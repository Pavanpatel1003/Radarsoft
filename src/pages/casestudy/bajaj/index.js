                        ...
                        <div className="row work-area-lower-sides">
                            ...
                            <div className="work-lower-left col-12 col-sm-12 col-md-12 col-lg-6">
                                ...
                                <h1 className="work-area-lower-heading">
                                    Bajaj Allianz The Key to Unmatched Business Performance
                                </h1>
                                <p className="work-area-lower-paragraph">
                                    The Bajaj Allianz platform is designed to empower businesses and individuals with comprehensive insights, streamlined performance tracking, and goal management tools. This platform provides a centralized hub where users can access essential metrics, set targets, and monitor their progress with ease.   </p>
