...
// import planet from "../../../../public/assets/media/case-details/Onlinekorp/MacBookPro14.png";
...
// import onlineKrop1 from "../../../../public/assets/media/case-details/Onlinekorp/MacBookPro16-1.png";
// import onlineKrop2 from "../../../../public/assets/media/case-details/Onlinekorp/MacBookPro17.png";
...
const Case_onlineKorp = () => {
    ...
    return (
        <>
            ...
            <section className="common_margin_space" style={{ marginTop: "0px" }}>
                        ...
                        <div className="row work-area-lower-sides">
                            ...
                            <div className="work-lower-left col-12 col-sm-12 col-md-12 col-lg-6">
                                ...
                                <h1 className="work-area-lower-heading">
                                    OnlineKorp Your Digital Corporate Service Provider
                                </h1>
                                <p className="work-area-lower-paragraph">
                                    OnlineKorp is your all-in-one digital platform for entrepreneurs, businesses, and startups. Whether you're launching a new venture or expanding an existing one, we provide the tools and services you need, including visa assistance and business account opening, to get started quickly. With step-by-step tutorials and an extensive FAQ section, we support you throughout the entire process.
                                </p>
                    ...
                    <div className="row">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-6">
                            <div className="commom-heading">
                                ...
                                <p>
                                    At OnlineKorp, our mission is to simplify the process of starting and growing a business by offering a digital platform that brings together essential services for entrepreneurs, startups, and small businesses. We are focused on providing practical, easy-to-use solutions that make business formation and management more accessible, transparent, and efficient.
                                </p>
                            </div>
                            <div className="sub-text">
                                <h6 className="normal-heading">Simplifying Business Formation</h6>
                                <p className="normal-desc">
                                    We simplify company registration, account opening, and access to legal and financial services, helping entrepreneurs get their business started quickly.
                                </p>
                            </div>
                            <div className="sub-text">
                                ...
                                <p className="normal-desc">
                                    With clear pricing and service details, we ensure entrepreneurs know exactly what they’re getting, with no hidden fees.
                                </p>
                            </div>
                            <div className="">
                                <h6 className="normal-heading">Support Every Step of the Way</h6>
                                <p className="normal-desc">
                                    Our easy-to-follow tutorials and FAQs guide users through the process, offering continuous support to help them succeed.
                                </p>
                            </div>
                        </div>
                        <div className="col-12 col-sm-12 col-md-12 col-lg-6">
            ...
            <section className="Empowering-sec common_margin_space">
                <div className="container">
                    <div className="row">
                        <div className="commom-heading">
                            <h2>
                                Effortless Digital Solutions for Your Business with OnlineKorp
                            </h2>
                            <p>
                                OnlineKorp is a digital platform that makes starting and growing a business easy. We offer services like business registration, visa assistance, and account opening, all in one place. With clear pricing, user-friendly features, and step-by-step guidance, OnlineKorp helps entrepreneurs and startups navigate the complexities of business formation, ensuring a smooth and hassle-free experience.
                            </p>
                        </div>
                    </div>
                    <div className="row emproving_secound">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-4 d-none">
                            ...
                            <p>
                                With over 50,000 users, OnlineKorp has successfully helped entrepreneurs and startups simplify business registration, account setup, and access to essential services. Our platform’s ease of use, clear pricing, and reliable support have made it a trusted choice for businesses looking to grow and succeed.
                            </p>
                            <div className="sub-text mt-60"></div>
                            <div className="sub-text mt-36 mb-60"></div>
                            <h4>Expanded Reach</h4>
                            <p>
                                OnlineKorp is committed to constant improvement, regularly updating our platform with new features based on user feedback and market trends. This ensures we stay aligned with the evolving needs of entrepreneurs and startups
                            </p>
                        </div>
            ...
            <section class="result-sec common_margin_space">
                <div class="container case-d-main-result">
                    ...
                    <div class="row row-cols-2 row-cols-sm-2 row-cols-lg-3 g-2 g-lg-3">
                        ...
                        <div class="col">
                            <div class="case-d-result p-3">
                                <span class="case-d-num">48,000+</span>
                                <span>
                                    <i class="fa-solid fa-arrow-up uparrow"></i>
                                </span>
                                <hr />
